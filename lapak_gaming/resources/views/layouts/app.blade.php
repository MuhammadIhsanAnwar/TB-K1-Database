...
<div id="gaming-bg"></div>
  ...
  {{-- Flash Messages & Validation Toasts --}}
  <div id="toast-container" class="fixed bottom-6 right-6 z-[9999] flex flex-col gap-3 max-w-[350px] w-full pointer-events-none">
    
    @if(session('success'))
    <div class="toast-item pointer-events-auto flex items-start gap-3 p-4 rounded-2xl bg-[#0b1121]/95 backdrop-blur-2xl border border-emerald-500/30 shadow-[0_10px_40px_rgba(16,185,129,0.2)] transform translate-x-[120%] opacity-0 transition-all duration-500 ease-out">
      <div class="w-10 h-10 shrink-0 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shadow-[inset_0_0_10px_rgba(16,185,129,0.2)]">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
      </div>
      <div class="flex-1 mt-0.5">
        <h4 class="text-sm font-bold text-emerald-400 mb-0.5">Berhasil</h4>
        <p class="text-xs text-slate-300 leading-relaxed">{{ session('success') }}</p>
      </div>
      <button onclick="closeToast(this)" class="shrink-0 text-slate-400 hover:text-white transition-colors p-1">
    ...
    @if(session('error'))
    <div class="toast-item pointer-events-auto flex items-start gap-3 p-4 rounded-2xl bg-[#0b1121]/95 backdrop-blur-2xl border border-rose-500/30 shadow-[0_10px_40px_rgba(244,63,94,0.2)] transform translate-x-[120%] opacity-0 transition-all duration-500 ease-out">
      <div class="w-10 h-10 shrink-0 rounded-full bg-rose-500/10 border border-rose-500/20 flex items-center justify-center text-rose-400 shadow-[inset_0_0_10px_rgba(244,63,94,0.2)]">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
      </div>
      <div class="flex-1 mt-0.5">
        <h4 class="text-sm font-bold text-rose-400 mb-0.5">Terjadi Kesalahan</h4>
        <p class="text-xs text-slate-300 leading-relaxed">{{ session('error') }}</p>
      </div>
      <button onclick="closeToast(this)" class="shrink-0 text-slate-400 hover:text-white transition-colors p-1">
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
      </button>
    ...
    @if(session('warning'))
    <div class="toast-item pointer-events-auto flex items-start gap-3 p-4 rounded-2xl bg-[#0b1121]/95 backdrop-blur-2xl border border-amber-500/30 shadow-[0_10px_40px_rgba(245,158,11,0.2)] transform translate-x-[120%] opacity-0 transition-all duration-500 ease-out">
      <div class="w-10 h-10 shrink-0 rounded-full bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 shadow-[inset_0_0_10px_rgba(245,158,11,0.2)]">
        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
      </div>
      <div class="flex-1 mt-0.5">
        <h4 class="text-sm font-bold text-amber-400 mb-0.5">Peringatan</h4>
        <p class="text-xs text-slate-300 leading-relaxed">{{ session('warning') }}</p>
      </div>
      <button onclick="closeToast(this)" class="shrink-0 text-slate-400 hover:text-white transition-colors p-1">
        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
      </button>
    ...
    <div class="toast-item pointer-events-auto flex items-start gap-3 p-4 rounded-2xl bg-[#0b1121]/95 backdrop-blur-2xl border border-rose-500/30 shadow-[0_10px_40px_rgba(244,63,94,0.2)] transform translate-x-[120%] opacity-0 transition-all duration-500 ease-out">
      ...
      <div class="flex-1 mt-0.5">
        <h4 class="text-sm font-bold text-rose-400 mb-1">Perbaiki data berikut</h4>
        <ul class="text-xs text-slate-300 leading-relaxed list-disc pl-3 space-y-0.5">
