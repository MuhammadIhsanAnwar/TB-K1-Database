        ...
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="text-xs font-bold uppercase tracking-widest text-amber-500/80">Seller Control Panel</span>
                </div>
                <h1 class="text-4xl font-extrabold text-white tracking-tight">Kelola Lapak Jualan</h1>
                <p class="mt-1.5 text-slate-400 text-sm font-medium">Pantau, tambah, dan atur komoditas gaming kamu dengan instan.</p>
            </div>
                ...
                <div class="group rounded-3xl p-5 md:p-6 premium-card">
                    <div class="flex flex-col gap-5 md:flex-row md:items-center">
                        ...
                        <div class="text-center md:text-right border-y md:border-none border-slate-800/50 py-3 md:py-0">
                            <div class="text-[11px] text-slate-500 font-bold uppercase tracking-wider mb-0.5">Harga Produk</div>
                    ...
                    {{-- ── CARD ACTIONS FOOTER ──────────────────────────── --}}
                    <div class="mt-5 flex flex-col sm:flex-row justify-end items-center gap-2 border-t border-slate-800/60 pt-4">
