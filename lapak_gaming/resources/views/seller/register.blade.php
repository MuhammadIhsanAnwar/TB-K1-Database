    ...
    @elseif(Auth::user()->seller_status === 'rejected')
      <div class="reveal-up delay-1 banner-rejected rounded-[30px] p-6">
        ...
        <p class="mt-3 text-sm text-red-200/80">
          ...
          {{ Auth::user()->seller_rejection_reason ?? 'Tidak ada keterangan.' }}
        </p>
      </div>
    @endif
        ...
        <form method="POST"
          ...
          <div>
            ...
            <textarea
              ...
              class="input-modern"
              placeholder="Ceritakan tentang toko Anda...">{{ old('shop_description', Auth::user()->shop_description) }}</textarea>
