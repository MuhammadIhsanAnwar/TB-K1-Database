    ...
    <div class="max-w-4xl mx-auto px-4 space-y-6 relative z-10">
        ...
        <div class="flex items-center justify-between gap-4 border-b border-white/5 pb-5">
            <div>
                ...
                <h1 class="text-2xl sm:text-3xl font-extrabold text-white tracking-tight invoice-token text-amber-400">
        ...
        <div class="rounded-3xl p-6 panel-card-glass">
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="p-4 rounded-2xl sub-panel-glass border border-white/5">
                    ...
                    <div class="text-2xl font-black text-white font-mono tracking-tight text-gradient bg-gradient-to-r from-white to-slate-400">
                        Rp {{ number_format($order->grand_total, 0, ',', '.') }}
                    </div>
                </div>

                {{-- Status Badging --}}
                <div class="p-4 rounded-2xl sub-panel-glass border border-white/5 flex flex-col justify-between items-start">
                    <p class="text-[10px] uppercase tracking-wider font-bold text-slate-500 mb-2">Status Validasi Alur</p>
                    @php
