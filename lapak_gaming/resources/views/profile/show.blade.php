...
<div class="min-h-screen bg-[#050816] px-4 py-14">
    ...
    <div class="mx-auto max-w-5xl space-y-7">
        ...
        {{-- HEADER --}}
        <div
            class="reveal relative overflow-hidden rounded-[32px] border border-blue-500/20 bg-gradient-to-br from-[#060816] via-[#091225] to-[#0B1730] px-7 py-8 shadow-[0_0_80px_rgba(37,99,235,0.12)]">
            ...
            <div class="relative z-10 flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    {{-- LOGO --}}
                    <div
                        class="hidden md:flex relative h-[120px] w-[120px] items-center justify-center rounded-full border border-blue-500/20 bg-blue-500/5 backdrop-blur-2xl">
        ...
        {{-- PROFILE CARD --}}
        <div
            class="reveal reveal-delay-1 overflow-hidden rounded-[30px] border border-white/10 bg-[#0B1220]/95 p-7 shadow-[0_0_50px_rgba(37,99,235,0.05)] backdrop-blur-xl">
            ...
            <div
                ...
                {{-- AVATAR --}}
                <div
                    class="relative flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 via-cyan-400 to-orange-400 text-3xl font-black text-white shadow-[0_0_30px_rgba(59,130,246,0.35)]">
            ...
            <div
                ...
                {{-- EMAIL --}}
                <div
                    class="rounded-2xl border border-white/5 bg-white/[0.03] p-5 transition duration-300 hover:border-blue-500/20 hover:bg-blue-500/[0.03]">
                ...
                {{-- FULL NAME --}}
                <div
                    class="rounded-2xl border border-white/5 bg-white/[0.03] p-5 transition duration-300 hover:border-orange-500/20 hover:bg-orange-500/[0.03]">
                ...
                {{-- MEMBER SINCE --}}
                <div
                    class="rounded-2xl border border-white/5 bg-white/[0.03] p-5 transition duration-300 hover:border-cyan-500/20 hover:bg-cyan-500/[0.03]">
                ...
                {{-- STATUS --}}
                <div
                    class="rounded-2xl border border-white/5 bg-white/[0.03] p-5 transition duration-300 hover:border-emerald-500/20 hover:bg-emerald-500/[0.03]">
