  ...
  <div class="w-full max-w-md animate-fade-up">
    ...
    <div class="text-center mb-8">
      <a href="{{ route('marketplace.home') }}" class="inline-flex items-center gap-2.5 mb-5">
        <img src="{{ asset('storage/logo/logo.png') }}" alt="Lapak Gaming" class="w-10 h-10 rounded-xl object-contain bg-white/5 p-1" style="box-shadow:0 0 20px rgba(37,99,235,0.4);">
