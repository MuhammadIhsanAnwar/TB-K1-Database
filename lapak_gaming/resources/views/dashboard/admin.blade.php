...
<div class="mx-auto max-w-7xl space-y-10 px-5 py-8 animate-fade-in">
    ...
    <div class="anim-fade-up anim-delay-2 grid gap-6 xl:grid-cols-4">
        ...
        <a href="{{ route('admin.hero-card.edit') }}"
           class="quick-link reveal dashboard-card glass-card group rounded-[30px] border border-blue-500/20 bg-[#0B1220]/95 p-6 transition hover:border-indigo-500/40 hover:bg-slate-800/60 hover:shadow-xl hover:shadow-indigo-500/5">
            <div class="quick-link-icon mb-4 inline-flex h-11 w-11 items-center justify-center rounded-[26px] bg-indigo-500/10 text-indigo-400">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            </div>
            <div class="flex items-start justify-between">
                <div>
                    <h2 class="text-lg font-bold text-white">3D Card</h2>
                    <p class="mt-1.5 text-sm leading-relaxed text-slate-400">Atur konten dinamis untuk efek 3D Card yang ada di halaman beranda.</p>
                </div>
                <svg class="mt-0.5 h-4 w-4 shrink-0 text-slate-600 transition group-hover:translate-x-1 group-hover:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                </svg>
            </div>
        </a>
