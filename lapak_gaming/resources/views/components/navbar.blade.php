...
<style>
  ...
  .profile-menu-item {
    ...
    padding: 10px 14px; border-radius: 12px; margin: 2px 8px;
  ...
  .profile-menu-item:hover .menu-icon { transform: scale(1.1); }
  ...
  .notif-item.unread:hover { background: rgba(6,182,212,.06); }
  .notif-icon-wrap {
        ...
        @if($authUser)
          @if(!$isAdminRoute && !$isAdminSettingsRoute)
            ...
            <div class="relative" id="notif-wrapper">
              <button id="notif-btn" onclick="toggleDropdown('notif-dropdown'); loadNotificationPreview();" class="nav-icon-btn text-white/90">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
                </svg>
                <span id="notif-badge" class="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 flex items-center justify-center rounded-full bg-red-500 text-white text-[10px] font-bold dd-hidden">0</span>
              </button>
              ...
              <div id="notif-dropdown"
                ...
                <div class="flex items-center justify-between px-5 py-4 border-b border-white/[0.06]"
                  ...
                  <button onclick="markAllNotifsRead()" class="text-[11px] font-semibold text-cyan-400 hover:text-cyan-300 transition px-2 py-1 rounded-lg hover:bg-cyan-500/10">
                    Tandai dibaca
                  </button>
                </div>
            ...
            @if(!$authUser?->isAdmin())
              ...
              <div class="relative">
                <a href="{{ route('chat.inbox') }}" class="nav-icon-btn text-white/90">
                  ...
                  <span id="chat-badge" class="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 flex items-center justify-center rounded-full bg-red-500 text-white text-[10px] font-bold dd-hidden">0</span>
                </a>
              </div>
              ...
              <div class="relative" id="cart-wrapper">
                ...
                <div id="cart-dropdown" class="dropdown-panel dd-hidden absolute right-0 top-full mt-3 w-72 z-[999] text-slate-200 overflow-hidden">
            ...
            <button id="user-dd-btn" onclick="toggleDropdown('user-dropdown')"
              ...
              <div class="relative">
                <img src="{{ $authUser?->avatar_url ?? $avatarFallback }}"
                  class="w-8 h-8 rounded-xl object-cover ring-2 ring-cyan-500/20 group-hover:ring-cyan-500/40 transition-all" alt="Avatar">
                <span class="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-400 rounded-full border-2 border-[#0d1528]"></span>
              </div>
              <div class="text-left hidden lg:block">
                <p class="text-[13px] font-bold text-white leading-tight truncate max-w-[100px]">{{ $authUser?->name ?? 'User' }}</p>
                <p class="text-[10px] text-slate-400 leading-tight">
                  {{ $authUser?->isAdmin() ? 'Administrator' : ($authUser?->isSellerAccount() ? 'Seller' : 'Member') }}
                </p>
              </div>
              <svg class="w-3.5 h-3.5 text-slate-400 group-hover:text-cyan-400 transition-colors ml-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="profile-dropdown-header">
                <div class="flex items-center gap-3 relative z-10">
                  <div class="relative">
                    ...
                    <span class="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-emerald-400 rounded-full border-2 border-[#0d1528]"></span>
                  </div>
                  <div class="flex-1 min-w-0">
                    ...
                    <span class="inline-flex items-center mt-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold
                ...
                @else
                  ...
                  @else
                    <a href="{{ route('seller.register.form') }}" class="profile-menu-item seller-cta">
                      ...
                      Daftar Jadi Penjual
                      <span class="ml-auto text-[9px] font-black bg-amber-500/20 text-amber-300 px-1.5 py-0.5 rounded-full">GRATIS</span>
                    </a>
                  @endif
                @endif
              ...
              <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('products.search', ['category' => 'game-top-up']) }}" class="group/card block p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-cyan-500/30 hover:bg-cyan-500/[0.03] transition-all duration-300 shadow-sm">
                  <div class="flex items-center justify-between">
                    <span class="block font-bold text-slate-100 group-hover/card:text-cyan-400 transition-colors">Game Top Up</span>
                    <span class="text-[10px] font-black tracking-wider text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded-md">INSTAN</span>
                  </div>
                ...
                <a href="{{ route('products.search', ['category' => 'game-key']) }}" class="group/card block p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-purple-500/30 hover:bg-purple-500/[0.03] transition-all duration-300 shadow-sm">
                  <div class="flex items-center justify-between">
                    <span class="block font-bold text-slate-100 group-hover/card:text-purple-400 transition-colors">Game Key & CD-Key</span>
                    <span class="text-[10px] font-black tracking-wider text-purple-400 bg-purple-500/10 px-2 py-0.5 rounded-md">PC STEAM</span>
                  </div>
                ...
                <a href="{{ route('products.search', ['category' => 'roblox']) }}" class="group/card block p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-amber-500/30 hover:bg-amber-500/[0.03] transition-all duration-300 shadow-sm">
                  <div class="flex items-center justify-between">
                    <span class="block font-bold text-slate-100 group-hover/card:text-amber-400 transition-colors">Roblox Center</span>
                    <span class="text-[10px] font-black tracking-wider text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded-md">POPULER</span>
                  </div>
                ...
                <a href="{{ route('products.search', ['category' => 'voucher']) }}" class="group/card block p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-emerald-500/30 hover:bg-emerald-500/[0.03] transition-all duration-300 shadow-sm">
                  <div class="flex items-center justify-between">
                    <span class="block font-bold text-slate-100 group-hover/card:text-emerald-400 transition-colors">Voucher & Gift Card</span>
                    <span class="text-[10px] font-black tracking-wider text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-md">PREMIUM</span>
                  </div>
