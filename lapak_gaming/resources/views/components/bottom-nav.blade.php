...
<div class="fixed bottom-0 left-0 right-0 z-[60] md:hidden">
  <div class="backdrop-blur-sm bg-black/40 border-t border-white/6 shadow-sm" style="padding-bottom: env(safe-area-inset-bottom, 0);">
    ...
    {{-- Kategori / Pencarian --}}
    <a href="{{ route('products.search') }}" class="flex flex-col items-center justify-center w-full h-full text-center {{ request()->routeIs('products.*', 'categories.*') ? 'text-itemku-blue' : 'text-gray-400 hover:text-gray-600' }}">
    ...
    {{-- Pesanan (Transaksi) --}}
    <a href="{{ route('orders.index') }}" class="flex flex-col items-center justify-center w-full h-full text-center relative {{ request()->routeIs('orders.*') ? 'text-itemku-blue' : 'text-gray-400 hover:text-gray-600' }}">
    ...
    {{-- Chat / Inbox --}}
    <a href="{{ route('chat.inbox') }}" class="flex flex-col items-center justify-center w-full h-full text-center relative {{ request()->routeIs('chat.*') ? 'text-itemku-blue' : 'text-gray-400 hover:text-gray-600' }}">
    ...
    {{-- Akun --}}
    <a href="{{ route('dashboard') }}" class="flex flex-col items-center justify-center w-full h-full text-center {{ request()->routeIs('dashboard', 'settings.*', 'profile.*') ? 'text-itemku-blue' : 'text-gray-400 hover:text-gray-600' }}">
