<?php $__env->startSection('title', 'Register Seller'); ?>
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-blue-900 via-gray-900 to-orange-900 py-16 pb-20">
        ...
        <div class="relative mx-auto grid max-w-7xl gap-8 px-4 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
            ...
            <section class="rounded-[2rem] bg-black/20 p-6 backdrop-blur-xl shadow-none border border-white/5 sm:p-8">
                ...
                <form method="POST" action="<?php echo e(route('seller.register')); ?>" enctype="multipart/form-data" class="mt-8 space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid gap-6 sm:grid-cols-[160px_1fr] sm:items-start">
                        <div>
                            ...
                            <div class="space-y-3">
                                <img
                                    src="<?php echo e(auth()->user()->shop_photo ? asset('storage/' . auth()->user()->shop_photo) : 'https://ui-avatars.com/api/?name=Toko&background=f59e0b&color=fff'); ?>"
                                ...
                                <?php $__errorArgs = ['shop_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-sm text-rose-500"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid gap-4">
                            <label class="block">
                                ...
                                <input name="shop_name" type="text" value="<?php echo e(old('shop_name', auth()->user()->shop_name)); ?>" placeholder="Contoh: Toko Game Keren" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-950 outline-none ring-0 transition focus:border-slate-950 dark:border-slate-700 dark:bg-slate-950 dark:text-white" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label class="block">
                                ...
                                <textarea name="shop_description" rows="4" placeholder="Cerita singkat tentang toko Anda" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-950 outline-none transition focus:border-slate-950 dark:border-slate-700 dark:bg-slate-950 dark:text-white"><?php echo e(old('shop_description', auth()->user()->shop_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="rounded-3xl border border-slate-800 bg-slate-950/90 p-6 text-slate-300">
                        ...
                        <div class="mt-4 grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <p class="mt-2 text-sm text-white"><?php echo e(auth()->user()->name); ?></p>
                            </div>
                            <div>
                                <p class="text-xs uppercase tracking-[0.25em] text-slate-500">Email</p>
                                <p class="mt-2 text-sm text-white"><?php echo e(auth()->user()->email); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-5 text-sm text-slate-500 dark:text-slate-400">
                    Ingin membeli saja? <a href="<?php echo e(route('register')); ?>" class="font-bold text-slate-950 underline-offset-4 hover:underline dark:text-white">Daftar sebagai pembeli</a>
                </div>
            </section>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\auth\register-seller.blade.php ENDPATH**/ ?>