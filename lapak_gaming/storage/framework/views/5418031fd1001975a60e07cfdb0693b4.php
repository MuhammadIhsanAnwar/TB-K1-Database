...
<?php $__env->startSection('title', 'Keranjang Belanja — Lapak Gaming'); ?>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-center shrink-0 pr-1 relative z-30">
                                    <input type="checkbox" 
                                           ...
                                           <?php echo e($item->is_selected ? 'checked' : ''); ?>

                                           onchange="toggleSelectItem(<?php echo e($item->id); ?>)">
                                </div>
                                ...
                                <div class="shrink-0 relative">
                                    <img src="<?php echo e($item->product->image_url); ?>"
                                         ...
                                         onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($item->product->name)); ?>&background=1e293b&color=f59e0b&bold=true&size=128';">
                                </div>
                                ...
                                <div class="flex-1 flex flex-col justify-center min-w-0">
                                    <div class="flex items-center gap-2 mb-1.5">
                                        <span
                                            ...
                                            TERSEDIA</span>
                                        <span
                                            class="px-2 py-0.5 bg-slate-800 text-slate-400 text-[10px] font-black uppercase rounded"><?php echo e($item->product->type ?? 'ITEM'); ?></span>
                                    </div>
                                    <h3
                                        class="text-lg font-bold text-white leading-tight mb-1 truncate group-hover:text-amber-500 transition-colors">
                                        <?php echo e($item->product->name); ?></h3>

                                    <div class="flex items-center gap-2 text-xs text-slate-400 mb-3">
                                        Seller: <span class="text-amber-500/80 font-bold"><?php echo e($item->product->seller->name); ?></span>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2 mt-2">
                                        <button type="button" 
                                                onclick="decrementQty(<?php echo e($item->id); ?>)" 
                                        ...
                                        <input type="number" 
                                               id="qty-input-<?php echo e($item->id); ?>" 
                                               value="<?php echo e($item->quantity); ?>" 
                                               min="1" 
                                               max="<?php echo e($item->product->stock); ?>"
                                               onchange="onQtyInputChange(<?php echo e($item->id); ?>, <?php echo e($item->product->stock); ?>)"
                                        ...
                                        <button type="button" 
                                                onclick="incrementQty(<?php echo e($item->id); ?>, <?php echo e($item->product->stock); ?>)" 
                                                class="w-8 h-8 rounded-lg bg-slate-800 text-slate-400 hover:bg-slate-700 hover:text-white flex items-center justify-center font-black text-lg select-none active:scale-95 transition-all">+</button>
                                    </div>
                        ...
                        <div class="rounded-[2rem] border border-slate-800 bg-slate-900/80 p-8 shadow-xl">
                            ...
                            <div class="space-y-4 border-b border-slate-800 pb-6 text-sm">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-white font-black"><?php echo e($cartItems->filter(fn($c) => $c->is_selected)->sum('quantity')); ?> Pcs</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-slate-500 font-bold uppercase tracking-tighter">Subtotal</span>
                                    <span class="text-white font-black text-base">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                            ...
                            <?php if($cartItems->filter(fn($c) => $c->is_selected)->isNotEmpty()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\cart\index.blade.php ENDPATH**/ ?>