...
<body>
    ...
    <script>
        ...
        function runMigration() {
            ...
            fetch('<?php echo e(route("setup.migrate.run")); ?>', {
                method: 'POST',
                headers: {
        ...
        function goToSetup() {
            window.location.href = '<?php echo e(route("setup.index")); ?>';
        }
        ...
        window.addEventListener('load', function () {
            fetch('<?php echo e(route("setup.migrate.status")); ?>', {
                headers: {
                    'Accept': 'application/json',
                }
            })
...
<?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\setup\migration.blade.php ENDPATH**/ ?>