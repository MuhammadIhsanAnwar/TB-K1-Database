        ...
        <div class="mt-8 space-y-5">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div
                    ...
                    <a href="<?php echo e(route('orders.show', $order->order_code)); ?>" class="block">
                            ...
                            <div class="mt-4 flex flex-wrap items-center gap-3">
                                ...
                                <div
                                    ...
                                    <div class="mt-1 text-sm font-semibold text-white">
                                        <?php echo e($order->created_at->translatedFormat('d F Y')); ?>
                    ...
                    <div class="mt-5 flex flex-wrap gap-3 border-t border-white/5 pt-5">
                        <a href="<?php echo e(route('orders.show', $order->order_code)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\orders\index.blade.php ENDPATH**/ ?>