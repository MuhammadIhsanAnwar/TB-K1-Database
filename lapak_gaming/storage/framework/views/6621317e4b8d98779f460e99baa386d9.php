<?php $__env->startSection('title', 'Lapak Gaming — Marketplace Game Terpercaya Indonesia'); ?>
      ...
      <div class="flex-1 text-center lg:text-left animate-fade-up">
        ...
        <div class="flex flex-wrap gap-6 mt-10 justify-center lg:justify-start">
          ...
          <div class="text-center lg:text-left">
            <div class="font-display font-bold text-2xl text-white js-stat-counter" data-target="<?php echo e($stat['num']); ?>">0</div>
      ...
      url="https://prod.spline.design/vNP16bdGzzl-ASAu/scene.splinecode">
        ...
        <div class="badge-float-b absolute z-30" style="bottom:96px;left:-20px;">
          <div class="rounded-2xl px-4 py-2.5 backdrop-blur-md"
            ...
            <div class="font-display font-bold text-white text-lg leading-none"><?php echo e(number_format($todayTransactions, 0, ',', '.')); ?></div>
          </div>
        </div>
        ...
        <div class="badge-float-c absolute z-30" style="bottom:12px;right:7px;">
          <div class="flex items-center gap-2 rounded-2xl px-3.5 py-2 backdrop-blur-md"
            ...
            <span class="font-display font-bold text-white text-sm"><?php echo e(number_format($averageRating ?: 0, 1)); ?></span>
...
<?php if(isset($heroBanners) && $heroBanners->count()): ?>
    ...
    <div class="overflow-hidden rounded-[28px] border border-slate-800 bg-slate-950/40 shadow-card-hover">
      <div class="relative">
        <div id="banner-track" class="banner-track flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory p-3 sm:p-4">
          ...
          <a href="<?php echo e($banner->link_url ?: '#'); ?>" class="banner-slide group relative flex-none w-[72%] sm:w-[56%] md:w-[38%] xl:w-[28%] overflow-hidden rounded-[24px] border border-slate-800 bg-slate-900">
            <div class="relative aspect-[4/5] overflow-hidden">
              <img src="<?php echo e($banner->image_url); ?>" alt="<?php echo e($banner->title); ?>" class="h-full w-full object-cover transition duration-500 group-hover:scale-105">
              ...
              <div class="absolute inset-0 flex items-end p-5 sm:p-6">
                <div class="max-w-md">
                  ...
                  <h3 class="mt-3 text-xl sm:text-2xl font-bold text-white"><?php echo e($banner->title); ?></h3>
                  <p class="mt-1 text-sm text-slate-300"><?php echo e($banner->subtitle); ?></p>
                </div>
              </div>
            </div>
          </a>
...
<section class="pb-16">
  ...
  <div class="max-w-7xl mx-auto px-4">
    ...
    <div class="flex items-center justify-between mb-8">
      ...
      <a href="<?php echo e(route('products.search')); ?>"
   ...
   class="cat-btn reveal-card reveal-delay-<?php echo e(($loop->index % 6) + 1); ?>
        ...
        <div class="relative z-10">
          ...
          <h3 class="text-white font-bold text-lg leading-tight mb-2
            ...
            <?php echo e(\Illuminate\Support\Str::limit($cat->name, 18)); ?>
...
<?php if(isset($categoryProducts) && $categoryProducts->count()): ?>
...
<section class="pb-28 overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto px-4 space-y-14">
    ...
    <?php $__currentLoopData = $categoryProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="relative overflow-hidden rounded-[38px]
          ...
          <div class="flex items-center gap-5">
            ...
            <div>
              ...
              <p class="text-slate-400 text-sm mt-2">
                <?php echo e($products->count()); ?> produk tersedia
              </p>
      ...
      <div class="relative z-10 pb-10">
        ...
        <div class="category-premium-track flex gap-5 overflow-x-auto px-7 md:px-10 scroll-smooth snap-x snap-mandatory"
          ...
          <div class="flex-none w-[72%] sm:w-[40%] md:w-[28%] xl:w-[20%] snap-start reveal-card reveal-up reveal-delay-<?php echo e(($loop->index % 6) + 1); ?>">

            <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="group relative block h-full rounded-[30px]
                        overflow-hidden
...
<section class="pb-14 reveal-card reveal-up">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $qt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <a href="<?php echo e(route('products.by-type', $qt['type'])); ?>"
               class="group relative overflow-hidden rounded-[30px] border <?php echo e($qt['border']); ?> bg-white/[0.03] backdrop-blur-xl p-6 hover:-translate-y-2 transition-all duration-500">

                
                <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500">

                    <div class="absolute inset-0 bg-gradient-to-br <?php echo e($qt['gradient']); ?>"></div>

                    <div class="absolute -top-10 -right-10 w-40 h-40 <?php echo e($qt['glow']); ?> blur-[80px] rounded-full"></div>
                ...
                <div class="relative z-10 flex flex-col h-full">
                    ...
                    <div class="flex items-start justify-between mb-8">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute inset-0 blur-2xl opacity-40 <?php echo e($qt['glow']); ?>"></div>
                        ...
                        <div class="px-3 py-1.5 rounded-full border text-[10px] uppercase tracking-[0.18em] font-bold backdrop-blur-xl <?php echo e($qt['badgeColor']); ?>">
                    ...
                    <div class="absolute top-6 left-6 z-20 flex flex-wrap gap-3">
                        ...
                        <div class="px-4 py-2 rounded-full bg-yellow-400/15 border border-yellow-400/30 backdrop-blur-xl">
                            <span class="text-yellow-300 text-xs font-bold">
                                ⭐ <?php echo e(number_format($product->average_rating ?? 5, 1)); ?>
...
<?php if($topupProducts->isNotEmpty()): ?>
...
<section class="pb-20 overflow-hidden reveal-card reveal-up">
  ...
  <div class="max-w-7xl mx-auto px-4 relative z-10">
    ...
    <div class="flex items-end justify-between mb-8">
      ...
      <a href="<?php echo e(route('products.by-type', 'topup')); ?>"
         class="hidden md:flex items-center gap-3
    ...
    <div class="relative">
       ...
       <div id="premium-topup-track"
        ...
        <?php $__currentLoopData = $topupProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="premium-slide
          ...
          <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="group relative block rounded-[28px]
                      overflow-hidden
                      border border-white/10
  ...
  <div class="max-w-7xl mx-auto px-4">
    <div class="reveal-card reveal-delay-2 rounded-2xl p-8 sm:p-12 relative overflow-hidden text-center"
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto mb-8">
        <?php $ratingBadge = number_format($averageRating ?: 0, 1); ?>
      <?php $__currentLoopData = [
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="flex flex-col items-center text-center">
          <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-3"
               style="background:rgba(37,99,235,0.12);border:1px solid rgba(37,99,235,0.25);">
            <svg class="w-5 h-5 text-brand-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($vp['icon']); ?>"/>
            </svg>
          </div>
          <div class="text-sm font-semibold text-white"><?php echo e($vp['label']); ?></div>
          <div class="text-xs text-slate-500 mt-0.5"><?php echo e($vp['sub']); ?></div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
...
<?php if(isset($featuredBanners) && $featuredBanners->count()): ?>
  ...
  <div class="max-w-7xl mx-auto px-4">
    ...
    <div class="relative rounded-[28px] border border-white/10 bg-slate-950/50 p-3 sm:p-4 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
      <div id="featured-banner-track" class="banner-track flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory">
        <?php $__currentLoopData = $featuredBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e($banner->link_url ?: '#'); ?>" class="banner-slide group relative flex-none w-[86%] sm:w-[58%] lg:w-[42%] overflow-hidden rounded-[24px] border border-slate-800 bg-slate-900 snap-start">
            <div class="relative aspect-[3/1] overflow-hidden">
              ...
              <div class="absolute inset-0 flex items-end p-5 sm:p-6">
                <div class="max-w-xl">
                  ...
                  <h3 class="mt-3 text-2xl sm:text-3xl font-black text-white"><?php echo e($banner->title); ?></h3>
                  <p class="mt-2 text-sm sm:text-base text-slate-300"><?php echo e($banner->subtitle); ?></p>
                </div>
              </div>
            </div>
          </a>
    ...
    <div class="grid lg:grid-cols-2 gap-10 items-start">
      ...
      <div class="space-y-4">
        ...
        <div class="overflow-hidden rounded-[28px]
          ...
          <button type="button"
                  data-faq-index="<?php echo e($index); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\marketplace\home.blade.php ENDPATH**/ ?>