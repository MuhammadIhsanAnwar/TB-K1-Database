...
<div class="mx-auto max-w-7xl space-y-10 px-5 py-8 animate-fade-in">
    ...
    <div class="anim-fade-up anim-delay-1 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="reveal dashboard-card glass-card group rounded-2xl border border-blue-500/20 border-t-2 border-t-blue-500/70 bg-[#0B1220]/95 p-4 hover:border-t-blue-400 hover:shadow-lg hover:shadow-blue-500/10">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($totalUsers)); ?></p>
        ...
        <div class="reveal dashboard-card glass-card group rounded-2xl border border-blue-500/20 border-t-2 border-t-indigo-500/70 bg-[#0B1220]/95 p-4 hover:border-t-indigo-400 hover:shadow-lg hover:shadow-indigo-500/10">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($buyers)); ?></p>
        ...
        <div class="reveal dashboard-card glass-card group rounded-2xl border border-blue-500/20 border-t-2 border-t-emerald-500/70 bg-[#0B1220]/95 p-4 hover:border-t-emerald-400 hover:shadow-lg hover:shadow-emerald-500/10">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($sellers)); ?></p>
        ...
        <div class="reveal dashboard-card glass-card group rounded-2xl border border-blue-500/20 border-t-2 border-t-rose-500/70 bg-[#0B1220]/95 p-4 hover:border-t-rose-400 hover:shadow-lg hover:shadow-rose-500/10">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($suspendedUsers)); ?></p>
        ...
        <div class="reveal dashboard-card glass-card group relative overflow-hidden rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-slate-900 p-4 hover:border-amber-500/60 hover:shadow-lg hover:shadow-amber-500/10 sm:col-span-2 lg:col-span-1">
            ...
            <p class="relative text-2xl font-black text-white"><?php echo e(number_format($sellerRequests)); ?></p>
        ...
        <a href="<?php echo e(route('admin.users.index', ['tab' => 'pending_verification'])); ?>"
           class="reveal dashboard-card glass-card group rounded-2xl border border-blue-500/20 border-t-2 border-t-yellow-500/70 bg-[#0B1220]/95 p-4 hover:border-t-yellow-400 hover:shadow-lg hover:shadow-yellow-500/10">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($pendingEmailVerifications)); ?></p>
        ...
        <div class="reveal dashboard-card glass-card group rounded-2xl border border-blue-500/20 border-t-2 border-t-purple-500/70 bg-[#0B1220]/95 p-4 hover:border-t-purple-400 hover:shadow-lg hover:shadow-purple-500/10">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($products)); ?></p>
        ...
        <div class="reveal dashboard-card glass-card group rounded-[26px] border border-blue-500/20 border-t-2 border-t-cyan-500/70 bg-[#0B1220]/95 p-4 hover:border-t-cyan-400 hover:shadow-lg hover:shadow-cyan-500/10 sm:col-span-2">
            ...
            <p class="text-2xl font-black text-white"><?php echo e(number_format($orders)); ?></p>
    ...
    <form method="GET" class="anim-fade-up anim-delay-2 mb-5 flex flex-wrap items-end gap-3 rounded-[26px] border border-blue-500/20 bg-[#0B1220]/95 p-4">
        <div class="min-w-[180px] flex-1">
            ...
            <select id="chart_period" name="chart_period" class="w-full rounded-2xl border border-white/10 bg-[#050816] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400">
                <option value="month" <?php if(($chartPeriod ?? 'month') === 'month'): echo 'selected'; endif; ?>>Bulanan</option>
                <option value="day" <?php if(($chartPeriod ?? 'month') === 'day'): echo 'selected'; endif; ?>>Harian</option>
                <option value="year" <?php if(($chartPeriod ?? 'month') === 'year'): echo 'selected'; endif; ?>>Tahunan</option>
            </select>
        </div>
        ...
        <div class="min-w-[180px]">
            ...
            <input
                ...
                type="date"
                name="start_date"
                value="<?php echo e($chartStartDate ?? request('start_date')); ?>"
        ...
        <div class="min-w-[180px]">
            ...
            <input
                ...
                type="date"
                name="end_date"
                value="<?php echo e($chartEndDate ?? request('end_date')); ?>"
                class="w-full rounded-2xl border border-white/10 bg-[#050816] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400"
            >
        </div>
        ...
        <div class="rounded-[26px] border border-blue-500/20 bg-[#0B1220]/95 p-6">
            <div class="mb-4 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-[11px] text-slate-500"><?php echo e($chartRangeLabel); ?></p>
                </div>
...
<div id="chart-data"
     data-labels="<?php echo e(base64_encode(json_encode($chartLabels))); ?>"
     data-transactions="<?php echo e(base64_encode(json_encode($chartTransactions))); ?>"
     data-revenue="<?php echo e(base64_encode(json_encode($chartRevenue))); ?>"
     hidden></div>
<script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\dashboard\admin.blade.php ENDPATH**/ ?>