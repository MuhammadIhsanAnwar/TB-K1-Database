<?php $__env->startSection('title', 'Chat — ' . ($conversation->partner(auth()->id())?->name ?? 'Percakapan')); ?>
...
<div class="chat-layout">
    ...
    <div class="chat-sidebar">
        <div class="sidebar-header">
            <a href="<?php echo e(route('chat.inbox', ['tab' => $role])); ?>" class="flex items-center gap-2 text-slate-400 hover:text-white mb-3 transition-colors">
        ...
        <div class="overflow-y-auto flex-1" id="sideList">
            <?php $__currentLoopData = $sidebarConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
            <a href="<?php echo e(route('chat.show', [
                    'conversation' => $conv->id,
                    'role' => $role
                ])); ?>"
               class="conv-item <?php echo e($active ? 'active' : ''); ?>"
               data-name="<?php echo e(strtolower($p2?->name ?? '')); ?>">
                <img src="<?php echo e($p2?->avatar_url ?? 'https://ui-avatars.com/api/?name=?'); ?>"
                     class="conv-avatar" alt="">
                <div class="conv-content">
                    <div class="flex justify-between items-center">
                        <span class="conv-name"><?php echo e($p2?->name ?? '?'); ?></span>
                        <span class="conv-time"><?php echo e($conv->last_message_at?->format('H:i')); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="conv-preview">
                            <?php echo e($conv->last_message ? mb_substr($conv->last_message, 0, 30) : '...'); ?>

                        </span>
                        <?php if($unread > 0): ?>
                        <span class="unread-badge"><?php echo e($unread > 9 ? '9+' : $unread); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </a>
    ...
    <div class="chat-main">
        ...
        <div class="chat-header">
            <img src="<?php echo e($partner?->avatar_url ?? 'https://ui-avatars.com/api/?name=?'); ?>"
                 class="chat-header-avatar" alt="<?php echo e($partner?->name); ?>">
            <div class="chat-header-info">
                <h2><?php echo e($partner?->name ?? 'Pengguna'); ?></h2>
                <p class="text-xs text-blue-400 mt-1">
                    <?php echo e($role === 'seller' ? 'Mode Seller' : 'Mode Buyer'); ?>

                </p>
                <?php if($product): ?>
                <p>🎮 <?php echo e($product->name); ?></p>
                <?php elseif($order): ?>
                <p>📦 Order #<?php echo e($order->order_code ?? $order->id); ?></p>
                <?php else: ?>
                <p>Online</p>
                <?php endif; ?>
            </div>
        ...
        <div class="product-context">
            ...
            <?php if($role === 'buyer'): ?>
                <a href="<?php echo e(route('checkout.product', $product)); ?>"
        ...
        <div id="messagesArea" class="messages-area">
            ...
            <div class="date-divider"><span><?php echo e($msgDate); ?></span></div>
            <?php $lastDate = $msgDate; ?>
            <?php endif; ?>

            <div class="message-item <?php echo e($isMine ? 'mine' : 'theirs'); ?>" data-msg-id="<?php echo e($msg->id); ?>">
                <?php if(!$isMine): ?>
                <img src="<?php echo e($msg->sender?->avatar_url); ?>" class="message-avatar" alt="">
                <?php endif; ?>
               <div class="message-bubble <?php echo e($isMine ? 'mine' : 'theirs'); ?>">
    <div class="bubble-content group relative">
        
        
        <?php if($isMine): ?>
        <div class="absolute -left-10 top-0 hidden group-hover:flex gap-1">
            <button onclick="prepareEdit('<?php echo e($msg->id); ?>')" class="p-1 text-gray-500 hover:text-blue-400">
            ...
            <button onclick="confirmDelete('<?php echo e($msg->id); ?>')" class="p-1 text-gray-500 hover:text-red-400">
        ...
        <?php if($msg->image_url): ?>
            <img src="<?php echo e($msg->image_url); ?>" class="max-w-xs rounded-lg mb-2 cursor-pointer" onclick="window.open(this.src)">
        <?php endif; ?>
        
        <p class="message-text" id="text-<?php echo e($msg->id); ?>"><?php echo e($msg->message); ?></p>
    </div>
    
    
    <div class="message-time <?php echo e($isMine ? 'mine' : 'theirs'); ?>">
        <span><?php echo e($msg->created_at->format('H:i')); ?></span>
    </div>
</div>
                <?php if($isMine): ?>
                <img src="<?php echo e($user->avatar_url); ?>" class="message-avatar mine" alt="">
                <?php endif; ?>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div id="typingIndicator" class="typing-indicator hidden">
                <img src="<?php echo e($partner?->avatar_url); ?>" class="typing-avatar" alt="">
...
<?php echo json_encode($chatConfig); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\chat\show.blade.php ENDPATH**/ ?>