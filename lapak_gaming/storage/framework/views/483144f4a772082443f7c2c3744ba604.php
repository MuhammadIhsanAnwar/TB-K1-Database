...
<div class="min-h-screen bg-gray-950 py-12 px-4">
    <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-white mb-4">Upgrade to <?php echo e(config('app.name')); ?> Pro</h1>
                ...
                <div class="flex gap-4">
                    <div class="flex-shrink-0">
                        <div class="flex items-center justify-center h-12 w-12 rounded-md bg-purple-500/20 text-purple-400">
                            <img src="<?php echo e(url('storage/app/public/logo/logo.png')); ?>" alt="Lapak Gaming" class="h-6 w-6 rounded-sm object-contain bg-white/10 p-0.5">
                        </div>
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\subscription\upgrade.blade.php ENDPATH**/ ?>