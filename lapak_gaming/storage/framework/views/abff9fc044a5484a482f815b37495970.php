<?php $__env->startSection('title', 'Checkout Produk'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-6xl mx-auto px-4 py-10" id="checkout-page"
     data-base-price="<?php echo e((float) $product->price); ?>"
     data-fee-percent="<?php echo e($feePercent); ?>">
    <div class="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="btn-ghost rounded-xl px-4 py-2 text-sm">Kembali ke Produk</a>
    </div>

    <form method="POST" action="<?php echo e(route('checkout.store')); ?>" class="grid gap-6 lg:grid-cols-[1fr_360px]">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-6">
            <div class="card p-5 sm:p-6">
                ...
                <div class="mt-5 flex flex-col gap-4 sm:flex-row">
                    <img src="<?php echo e($product->image_url); ?>"
                         ...
                         loading="lazy"
                         data-fallback="<?php echo e(asset('images/default-product.png')); ?>"
                         onerror="this.onerror=null;this.src=this.dataset.fallback;">

                    <div class="min-w-0 flex-1">
                        <div class="flex flex-wrap items-center gap-2">
                            <?php if($product->category): ?>
                                <span class="badge badge-blue"><?php echo e($product->category->name); ?></span>
                            <?php endif; ?>
                            <span class="badge badge-green">Stok <?php echo e($product->stock); ?></span>
                        </div>
                        <h3 class="mt-3 text-xl font-bold text-white"><?php echo e($product->name); ?></h3>
                        <p class="mt-2 text-sm text-slate-400">Penjual: <?php echo e($product->seller?->name ?? '-'); ?></p>
                ...
                <div class="mt-6 max-w-xs">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input id="checkout-qty" type="number" name="quantity" min="1" max="<?php echo e($product->stock); ?>" value="<?php echo e($quantity); ?>"
            ...
            <div class="card p-5 sm:p-6">
                ...
                <div class="mt-4 rounded-xl border border-brand-400/20 bg-brand-900/20 px-4 py-4 text-sm text-slate-200">
                    ...
                    <div class="mt-2 text-xs text-slate-500">Saldo tersedia Rp <?php echo e(number_format($availableBalance, 0, ',', '.')); ?></div>
                </div>
            </div>
        </div>
        ...
        <aside class="card-glow-border h-fit p-6 lg:sticky lg:top-20">
            ...
            <div class="mt-5 space-y-3 text-sm">
                <div class="flex items-center justify-between gap-4 text-slate-400">
                    <span>Subtotal</span>
                    <span id="checkout-subtotal">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                </div>
                <div class="flex items-center justify-between gap-4 text-slate-400">
                    <span>Biaya Platform <?php echo e($feePercent); ?>%</span>
                    <span id="checkout-fee">Rp <?php echo e(number_format($feeAmount, 0, ',', '.')); ?></span>
                </div>
                <div class="border-t border-slate-800 pt-4">
                    <div class="flex items-center justify-between gap-4">
                        <span class="font-bold text-white">Total Pembayaran</span>
                        <span id="checkout-total" class="font-display text-xl font-extrabold text-white">Rp <?php echo e(number_format($grandTotal, 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\orders\product-checkout.blade.php ENDPATH**/ ?>