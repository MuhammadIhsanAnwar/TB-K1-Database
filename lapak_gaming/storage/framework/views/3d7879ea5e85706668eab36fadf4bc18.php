...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo e(url('storage/app/public/logo/logo.png')); ?>">
  <link rel="apple-touch-icon" href="<?php echo e(url('storage/app/public/logo/logo.png')); ?>">
  <title><?php echo $__env->yieldContent('title', config('app.name', 'Lapak Gaming')); ?> — Marketplace Game Terpercaya</title>
...
<script>
  window.chatInboxUrl = '<?php echo route('chat.inbox.poll'); ?>';
</script>
      ...
      <ul class="space-y-1">
        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li class="text-sm text-red-300 flex items-center gap-2">
            <span class="w-1 h-1 rounded-full bg-red-400 shrink-0"></span><?php echo e($error); ?>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  <script type="text/x-template">
    window.sessionAlert = <?php echo json_encode(session('alert')); ?>;
  </script>
  <script>
...
</html><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\layouts\app.blade.php ENDPATH**/ ?>