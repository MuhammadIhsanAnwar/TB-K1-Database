<?php $__env->startSection('title', $category->name . ' — Lapak Geming'); ?>

<?php $__env->startSection('content'); ?>
<section class="max-w-7xl mx-auto px-4 py-12">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-white">Kategori: <?php echo e($category->name); ?></h1>
            <p class="text-sm text-gray-400 mt-2">Menampilkan produk dalam kategori <?php echo e(strtolower($category->name)); ?>.</p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\products\category.blade.php ENDPATH**/ ?>