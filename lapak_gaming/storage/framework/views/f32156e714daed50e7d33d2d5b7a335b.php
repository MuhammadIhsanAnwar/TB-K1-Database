<?php $__env->startSection('title', 'Daftar — Lapak Gaming'); ?>
...
<div class="relative min-h-screen py-12 px-4 overflow-hidden">
  ...
  <div class="relative max-w-6xl mx-auto z-10">
    ...
    <div class="flex items-center justify-between mb-8 animate-fade-up">
      <a href="<?php echo e(route('marketplace.home')); ?>" class="inline-flex items-center gap-2.5 group">
        <div class="relative">
        ...
        <span class="font-display font-bold text-lg text-white"><?php echo e(config('app.name', 'Lapak Gaming')); ?></span>
      </a>
      <a href="<?php echo e(route('login')); ?>" class="text-sm text-slate-400 hover:text-white transition-colors flex items-center gap-1.5">
  ...
  Jutaan Gamer
      ...
      <div class="form-panel p-7">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" class="space-y-5" id="register-form" data-register-form novalidate>
          <?php echo csrf_field(); ?>
              ...
              <div>
                ...
                <div class="input-icon-wrap">
                  ...
                  <input id="name" name="name" type="text" value="<?php echo e(old('name')); ?>"
                         ...
                         class="<?php echo e($inputClass); ?> has-icon" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select id="gender" name="gender" class="<?php echo e($inputClass); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                  ...
                  <input id="birth_date" name="birth_date" type="date" value="<?php echo e(old('birth_date')); ?>"
                         class="<?php echo e($inputClass); ?>" required>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div>
                ...
                <div class="input-icon-wrap relative">
                  ...
                  <input id="password" name="password" type="password"
                         ...
                         class="<?php echo e($inputClass); ?> has-icon pr-11" required>
              ...
              <div class="flex items-start gap-2.5">
                ...
                <label for="terms_agree" class="text-xs text-slate-400 cursor-pointer leading-relaxed">
                  Saya menyetujui
                  <a href="<?php echo e(route('terms')); ?>" class="text-brand-400 hover:underline">Syarat & Ketentuan</a>
                  serta
                  <a href="<?php echo e(route('privacy')); ?>" class="text-brand-400 hover:underline">Kebijakan Privasi</a>
                  Lapak Gaming
                </label>
              </div>
          ...
          <a href="<?php echo e(route('google.auth')); ?>" class="btn-google-reg">
          ...
          <p class="text-center text-xs text-slate-500">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="text-brand-400 hover:text-brand-300 font-semibold transition-colors hover:underline ml-1">Masuk sekarang</a>
          </p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\auth\register.blade.php ENDPATH**/ ?>