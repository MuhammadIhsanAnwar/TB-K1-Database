        ...
        <div class="reveal relative overflow-hidden rounded-[30px] border border-blue-500/20 bg-gradient-to-br from-[#060816] via-[#091225] to-[#0B1730] p-8 shadow-[0_0_80px_rgba(37,99,235,0.12)]">
            ...
            <div class="relative z-10">
                            ...
                            <div class="flex flex-col gap-4 px-6 py-5 transition duration-300 hover:bg-blue-500/[0.04] md:flex-row md:items-center md:justify-between">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 text-sm text-slate-400">
                                        Jumlah: <?php echo e($item->quantity); ?>
                ...
                <div class="mt-8 grid gap-5 md:grid-cols-2">
                    ...
                    <div class="rounded-[26px] border border-white/5 bg-white/[0.03] p-6 transition duration-300 hover:border-blue-500/30 hover:bg-blue-500/[0.04]">
                        ...
                        <div class="mt-3 text-lg font-bold text-white">
                            <?php echo e(ucfirst(str_replace('_', ' ', $order->payment_method ?? 'Belum dipilih'))); ?>
                ...
                <div class="relative z-10 mt-8 grid gap-4 md:grid-cols-2">
                    ...
                    <a href="<?php echo e(route('chat.order', $order)); ?>"
                    ...
                    <?php if($order->buyer_id === auth()->id() && $order->status === \App\Models\Order::STATUS_COMPLETED): ?>
                        <a href="<?php echo e(route('orders.receipt.pdf', $order->order_code)); ?>"
                           target="_blank"
                    ...
                    <?php if(in_array($order->status, [\App\Models\Order::STATUS_PENDING_PAYMENT, \App\Models\Order::STATUS_PAYMENT_UPLOADED], true)): ?>
                ...
                <div class="reveal reveal-delay-3 mt-8 rounded-[26px] border border-white/5 bg-white/[0.03] p-6">
                    ...
                    <div class="mt-5 overflow-hidden rounded-[24px] border border-white/10">
                        ...
                        <a href="<?php echo e(asset('storage/' . $order->payment_proof)); ?>"
                           target="_blank"
                           rel="noopener noreferrer">
                ...
                <?php elseif($order->status === \App\Models\Order::STATUS_PENDING_PAYMENT): ?>
                ...
                <div class="reveal reveal-delay-3 mt-8 rounded-[26px] border border-white/5 bg-white/[0.03] p-6">
                    ...
                    <?php if($order->payment_method === 'balance'): ?>
                        ...
                        <form action="<?php echo e(route('orders.pay', $order)); ?>" method="POST" class="mt-6">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        ...
                        <form action="<?php echo e(route('orders.proof', $order)); ?>"
                              method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\orders\show.blade.php ENDPATH**/ ?>