...
<aside id="mobile-drawer" class="fixed top-0 left-0 h-full w-72 z-50 flex flex-col overflow-y-auto"
  ...
  <div class="flex items-center justify-between p-4" style="border-bottom:1px solid #1E2D45;">
    <a href="<?php echo e(route('marketplace.home')); ?>" class="flex items-center gap-2.5">
      <img src="<?php echo e(url('storage/app/public/logo/logo.png')); ?>" alt="Lapak Gaming" class="w-8 h-8 rounded-lg object-contain bg-white/5 p-1 shadow-glow-sm">
      <span class="font-display font-bold text-base text-white tracking-wide"><?php echo e(config('app.name', 'Lapak Gaming')); ?></span>
    </a>
  ...
  <div class="p-4" style="border-bottom:1px solid #1E2D45;">
    <div class="flex items-center gap-3 p-3 rounded-xl" style="background:#162032;border:1px solid #1E2D45;">
       <img src="<?php echo e($authUser?->avatar_url ?? $avatarFallback); ?>"
         alt="Foto profil <?php echo e($authUser?->name ?? 'User'); ?>"
      ...
      <div class="flex-1 min-w-0">
        <div class="text-sm font-semibold text-white truncate"><?php echo e($authUser?->name ?? 'User'); ?></div>
        <div class="text-xs text-slate-400 truncate"><?php echo e($authUser?->email ?? ''); ?></div>
      </div>
      <?php if(Auth::user()->is_pro ?? false): ?>
  ...
  <div class="p-4" style="border-bottom:1px solid #1E2D45;">
    <div class="grid grid-cols-2 gap-2">
      <a href="<?php echo e(route('login')); ?>" class="btn-ghost text-center text-sm py-2.5 px-3 rounded-xl">Login</a>
      <a href="<?php echo e(route('register')); ?>" class="dg-btn group relative inline-flex items-center justify-center overflow-hidden rounded-xl py-2.5 px-3 font-display font-bold text-white transition-all duration-300 text-sm">
  ...
  <nav class="p-4 flex-1 space-y-6">
    <div>
      ...
      <ul class="space-y-0.5">
        ...
        <li>
          <a href="<?php echo e(route($item['route'])); ?>"
             class="flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium text-sm transition-all
                    <?php echo e(request()->routeIs($item['route']) ? 'text-brand-400' : 'text-slate-400 hover:text-white hover:bg-surface-750'); ?>"
             <?php if(request()->routeIs($item['route'])): ?> style="background:rgba(37,99,235,0.1);border:1px solid rgba(37,99,235,0.2);" <?php endif; ?>>
            <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($item['icon']); ?>"/></svg>
            <?php echo e($item['label']); ?>

            <?php if(isset($item['badge'])): ?>
              <span class="ml-auto badge <?php echo e($item['badge']['class']); ?>"><?php echo e($item['badge']['text']); ?></span>
            <?php endif; ?>
          </a>
        </li>
        ...
        <?php if(auth()->guard()->check()): ?>
        <li>
          <a href="<?php echo e(route('wishlist.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 font-medium text-sm transition-all">
    ...
    <div>
      ...
      <ul class="space-y-0.5">
        <?php $__currentLoopData = $categories->take(13); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
          <a href="<?php echo e(route('categories.show', $category->slug)); ?>"
            ...
            <?php if(!empty($category->image)): ?>
              <img src="<?php echo e($category->image_url); ?>" alt="<?php echo e($category->name); ?>" class="w-5 h-5 rounded object-cover shrink-0" loading="lazy">
            <?php else: ?>
              <span class="text-base leading-none"><?php echo e($category->icon ?? '🎮'); ?></span>
            <?php endif; ?>
    ...
    <div>
      ...
      <ul class="space-y-0.5">
        <?php if($authUser?->isAdmin()): ?>
          <li>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
          ...
          <li>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
          ...
          <li>
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
          ...
          <li>
            <a href="<?php echo e(route('admin.banners.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
          ...
          <li>
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
              <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
              Notifikasi
            </a>
          </li>
          <li>
            <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
          ...
          <li>
            <a href="<?php echo e(route('settings.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
              <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
              Pengaturan
            </a>
          </li>
          <li>
            <a href="<?php echo e(route('settings.password')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
        ...
        <?php else: ?>
          ...
          <li>
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
              <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h4a1 1 0 011 1v5a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1v-4zm10-2a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1h-4a1 1 0 01-1-1v-6z"/></svg>
              Dashboard
            </a>
          </li>
          ...
          <li>
            <a href="<?php echo e(route('wallet.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
          ...
          <li>
            <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
              <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
              Pesanan
            </a>
          </li>
          <?php if($authUser?->isSellerAccount()): ?>
          <li>
            <a href="<?php echo e(route('seller.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-surface-750 text-sm transition-all">
  ...
  <div class="p-4" style="border-top:1px solid #1E2D45;">
    <div class="rounded-xl p-4 relative overflow-hidden" style="background:linear-gradient(135deg,rgba(37,99,235,0.2),rgba(249,115,22,0.1));border:1px solid rgba(37,99,235,0.3);">
      <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('subscription.upgrade')); ?>" class="text-xs btn-primary py-2 px-3 rounded-lg">
          Upgrade ↗
        </a>
      </div>
    </div>
...
<header id="main-navbar"
  ...
  <div class="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
    ...
    <a href="<?php echo e(route('marketplace.home')); ?>" class="flex items-center gap-2 shrink-0 group">
      <img src="<?php echo e(url('storage/app/public/logo/logo.png')); ?>" alt="Lapak Gaming" class="w-8 h-8 rounded-lg object-contain bg-white/5 p-1 transition-transform group-hover:scale-105" style="box-shadow:0 0 12px rgba(37,99,235,0.35);">
      <span class="font-display font-bold text-white text-base hidden sm:block"><?php echo e(config('app.name', 'Lapak Gaming')); ?></span>
    </a>

    
    <nav class="hidden lg:flex items-center gap-1 ml-2">
        <?php if($authUser?->isAdmin()): ?>
          <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">Panel Admin</a>
          <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-link px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">Kelola Akun</a>
          <a href="<?php echo e(route('admin.orders.index')); ?>" class="nav-link px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">Transaksi</a>
          <a href="<?php echo e(route('admin.banners.index')); ?>" class="nav-link px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.banners.*') ? 'active' : ''); ?>">Banner</a>
          <a href="<?php echo e(route('admin.notifications.index')); ?>" class="nav-link px-3 py-1.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.notifications.*') ? 'active' : ''); ?>">Notifikasi</a>
        <?php else: ?>
          <a href="<?php echo e(route('marketplace.home')); ?>"
              class="nav-link px-3 py-1.5 rounded-lg text-sm font-medium
              <?php echo e(request()->routeIs('marketplace.home') ? 'active' : ''); ?>">
              Beranda
            </a>
              ...
              <div class="grid grid-cols-[300px_minmax(0,1fr)] gap-0">
                <div class="p-2" style="border-right:1px solid #1E2D45;">
                      ...
                      <?php $__currentLoopData = $navCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group/category relative">
                          <a href="<?php echo e(route('categories.show', $cat->slug)); ?>"
                            ...
                            <img src="<?php echo e($cat->image_url); ?>" alt="<?php echo e($cat->name); ?>" class="w-8 h-8 rounded-lg object-cover shrink-0 bg-slate-900/40" loading="lazy">
                            <span class="flex-1 min-w-0 truncate font-medium"><?php echo e($cat->name); ?></span>
                            <span class="text-[11px] uppercase tracking-[0.18em] text-slate-500"><?php echo e($cat->children->count()); ?></span>
                          </a>
                              ...
                              <div class="rounded-2xl border border-white/10 bg-[#0B1220] p-4 shadow-2xl">
                                <div class="flex items-start justify-between gap-4 border-b border-white/5 pb-4">
                                  <div class="flex items-center gap-3 min-w-0">
                                    <img src="<?php echo e($cat->image_url); ?>" alt="<?php echo e($cat->name); ?>" class="w-11 h-11 rounded-xl object-cover shrink-0 bg-slate-900/40" loading="lazy">
                                    <div class="min-w-0">
                                      <div class="text-base font-semibold text-white truncate"><?php echo e($cat->name); ?></div>
                                      <div class="text-xs text-slate-400 mt-1"><?php echo e($cat->children->count()); ?> subkategori tersedia</div>
                                    </div>
                                  </div>
                                  <a href="<?php echo e(route('categories.index')); ?>" class="shrink-0 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-cyan-300 hover:bg-cyan-400 hover:text-black transition-colors">
                                    Tampilkan semua kategori
                                  </a>
                                </div>

                                <div class="mt-4 grid grid-cols-2 gap-2">
                                  <?php $__currentLoopData = $cat->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('categories.show', $subCategory->slug)); ?>"
                                      ...
                                      <img src="<?php echo e($subCategory->image_url); ?>" alt="<?php echo e($subCategory->name); ?>" class="h-10 w-10 rounded-lg object-cover shrink-0 bg-slate-900/40" loading="lazy">
                                      <span class="min-w-0 flex-1 truncate"><?php echo e($subCategory->name); ?></span>
                                    </a>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                              </div>
                  ...
                  <div class="mt-3 pt-3" style="border-top:1px solid #1E2D45;">
                    <a href="<?php echo e(route('categories.index')); ?>" class="flex items-center justify-center gap-2 rounded-xl border border-cyan-400/20 bg-cyan-400/10 px-4 py-2.5 text-sm font-semibold text-cyan-300 hover:bg-cyan-400 hover:text-black transition-colors">
                      Tampilkan semua kategori
                    </a>
                  </div>
                </div>
                ...
                <div class="hidden xl:flex flex-col justify-between p-5">
                  ...
                  <div class="grid grid-cols-2 gap-3 mt-6">
                    <a href="<?php echo e(route('categories.index')); ?>" class="rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-left hover:border-cyan-400/25 hover:bg-cyan-400/10 transition-colors">
                    ...
                    <a href="<?php echo e(route('products.search')); ?>" class="rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-left hover:border-cyan-400/25 hover:bg-cyan-400/10 transition-colors">
          ...
          <a href="<?php echo e(route('marketplace.trending')); ?>"
            class="nav-link flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium
            <?php echo e(request()->routeIs('marketplace.trending') ? 'active' : ''); ?>">
            Trending
    ...
    <?php if(! $isAdminRoute && ! $isAdminSettingsRoute): ?>
    <form action="<?php echo e(route('products.search')); ?>" method="GET" class="hidden md:flex flex-1 max-w-md mx-auto">
    ...
    <div class="flex items-center gap-1.5 ml-auto">
      ...
      <a href="<?php echo e(route('products.search')); ?>" class="md:hidden w-9 h-9 rounded-lg flex items-center justify-center text-slate-400 hover:text-white transition-colors" style="background:#162032;border:1px solid #1E2D45;">
      ...
      <div class="relative">
        ...
        <div id="notif-dropdown" data-notifications-url="<?php echo e(route('notifications.poll')); ?>" class="dropdown-panel absolute right-0 top-full mt-2 w-80 rounded-xl shadow-card-hover"
             data-notifications-read-all-url="<?php echo e(route('notifications.read-all')); ?>"
             style="background:#0D1421;border:1px solid #1E2D45;">
          <div class="flex items-center justify-between px-4 py-3" style="border-bottom:1px solid #1E2D45;">
            ...
            <div class="flex items-center gap-3">
              ...
              <a href="<?php echo e(route('notifications.index')); ?>" class="text-xs text-brand-400 hover:text-brand-300">Lihat semua</a>
            </div>
          </div>
      ...
      <div class="relative">
        <a href="<?php echo e(route('chat.inbox')); ?>" class="relative w-9 h-9 rounded-lg flex items-center justify-center text-slate-400 hover:text-white transition-colors" style="background:#162032;border:1px solid #1E2D45;" aria-label="Chat">
      ...
      <div id="cart-dropdown" class="dropdown-panel absolute right-0 top-full mt-2 w-72 rounded-xl shadow-card-hover"
          ...
          <div class="px-4 py-3" style="border-bottom:1px solid #1E2D45;">
            <div class="flex items-center justify-between gap-3">
              ...
              <a href="<?php echo e(route('cart.index')); ?>" class="text-xs text-brand-400 hover:text-brand-300">Lihat semua</a>
            </div>
          </div>
          <?php if($authUser && $cartItems->isNotEmpty()): ?>
            <div class="max-h-80 overflow-y-auto divide-y divide-slate-800/80">
              <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('cart.index')); ?>" class="flex items-start gap-3 px-4 py-3 hover:bg-surface-850 transition-colors">
                  ...
                  <div class="min-w-0 flex-1">
                    <div class="text-sm text-white font-medium truncate"><?php echo e($item->product?->name ?? 'Produk'); ?></div>
                    <div class="mt-0.5 text-xs text-slate-500">
                      <?php echo e($item->quantity); ?> x Rp <?php echo e(number_format((float) ($item->product?->price ?? 0), 0, ',', '.')); ?>
          ...
          <?php else: ?>
            <div class="px-4 py-8 text-center">
              ...
              <a href="<?php echo e(route('products.search')); ?>" class="mt-3 inline-block text-xs text-brand-400 hover:text-brand-300">Mulai belanja →</a>
            </div>
          <?php endif; ?>
        </div>
      ...
      <div class="relative">
        <button onclick="toggleDropdown('user-dropdown')" class="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-xl transition-colors" style="background:#162032;border:1px solid #1E2D45;" aria-label="User menu">
          <img src="<?php echo e($authUser?->avatar_url ?? $avatarFallback); ?>"
            ...
            style="background:#162032;border:1px solid #1E2D45;"
            onerror="this.onerror=null;this.src='<?php echo e($avatarFallback); ?>';">
          <span class="hidden sm:block text-sm font-medium text-slate-200 max-w-[80px] truncate"><?php echo e($authUser?->name ?? 'User'); ?></span>
        ...
        <div id="user-dropdown" class="dropdown-panel absolute right-0 top-full mt-2 w-52 rounded-xl shadow-card-hover overflow-hidden"
          ...
          <div class="px-4 py-3" style="border-bottom:1px solid #1E2D45;">
            <div class="text-sm font-semibold text-white truncate"><?php echo e($authUser?->name ?? 'User'); ?></div>
            <div class="text-xs text-slate-400 truncate mt-0.5"><?php echo e($authUser?->email ?? ''); ?></div>
          </div>
          <div class="p-1.5">
            <?php if($authUser?->isAdmin()): ?>
              ...
              <a href="<?php echo e(route($link['route'])); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-slate-400 hover:text-white transition-all">
                <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($link['icon']); ?>"/></svg>
            ...
            <?php else: ?>
              ...
              <?php if($authUser?->isSellerAccount()): ?>
              <a href="<?php echo e(route('seller.dashboard')); ?>" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-slate-400 hover:text-white transition-all">
              ...
              <?php else: ?>
              <a href="<?php echo e(route('seller.register.form')); ?>" class="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-amber-300 hover:text-amber-200 hover:bg-amber-900/20 transition-all">
                  <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <a href="<?php echo e(route('login')); ?>" class="btn-ghost py-2 px-4 text-sm rounded-xl">Masuk</a>
      <a href="<?php echo e(route('register')); ?>" class="inline-flex dg-btn group relative items-center justify-center overflow-hidden rounded-xl px-4 py-2 font-display font-bold text-white transition-all duration-300 text-sm">
...
</header><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\components\navbar.blade.php ENDPATH**/ ?>