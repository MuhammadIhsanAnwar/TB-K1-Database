<?php $__env->startSection('title', 'Lupa Password — Lapak Gaming'); ?>
    ...
    <div class="auth-card-fp p-8">
      ...
      <div class="status-banner mb-5">
        ...
        <div>
          ...
          <p class="text-xs text-emerald-400/80"><?php echo e(session('status')); ?></p>
        </div>
      </div>
      <?php endif; ?>
      ...
      <form method="POST" action="<?php echo e(route('password.email')); ?>" id="fp-form">
        <?php echo csrf_field(); ?>
        <div class="mb-5">
          ...
          <div class="input-icon-wrap">
            ...
            <input name="email" id="email" type="email"
                   ...
                   class="input <?php echo e($errors->any() ? 'border-red-500/50' : ''); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>