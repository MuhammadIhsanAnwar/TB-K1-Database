...
<body>
    <div class="wrap">
        ...
        <div class="panel panel-pad">
            ...
            <div class="grid">
                <?php $__currentLoopData = $availableCommands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $command => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="cmd" type="button" data-command="<?php echo e($command); ?>" onclick="runPresetCommand(this.dataset.command)">
                        <strong><?php echo e($label); ?></strong>
                        <span>Jalankan <?php echo e($command); ?> dari browser.</span>
                    </button>
    ...
    <script>
        const QUICK_URL = "<?php echo e(route('artisan.terminal.quick')); ?>";
        const EXECUTE_URL = "<?php echo e(route('artisan.terminal.execute')); ?>";
...
</html><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\admin\terminal\index.blade.php ENDPATH**/ ?>