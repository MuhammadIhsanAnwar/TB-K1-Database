...
<body>
    <div class="setup-container">
        ...
        <form method="POST" action="<?php echo e(route('setup.storeAdmin')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    value="<?php echo e(old('email', 'administrator@lapakgaming.neoverse.my.id')); ?>"
                    required
                >
...
<?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\setup\admin-setup.blade.php ENDPATH**/ ?>