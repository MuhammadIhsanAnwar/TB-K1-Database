    ...
    <div class="reveal rounded-[26px] border border-red-700/50 bg-red-900/20 p-6 shadow-lg">
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-red-300 mt-1"><?php echo e($user->seller_rejection_reason ?? 'Alasan penolakan tidak tersedia.'); ?></p>
                <a href="<?php echo e(route('seller.register.form')); ?>" class="text-sm text-red-400 hover:text-red-300 mt-2 inline-block underline">Ajukan Kembali →</a>
            </div>
        </div>
    </div>
    <?php endif; ?>
        ...
        <section
            ...
            <div class="flex items-center justify-between">
                ...
                <div
                    ...
                    <?php echo e($orders->count()); ?> Orders
                </div>
            </div>
            ...
            <div class="mt-5 space-y-3">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        ...
                        <div class="mt-2 text-xs text-slate-400">
                            Total Rp
                            <?php echo e(number_format($order->grand_total, 0, ',', '.')); ?>
        ...
        <section
            ...
            <div class="flex items-center justify-between">
                ...
                <div
                    ...
                    <?php echo e($notifications->count()); ?> Alerts
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\dashboard\buyer.blade.php ENDPATH**/ ?>