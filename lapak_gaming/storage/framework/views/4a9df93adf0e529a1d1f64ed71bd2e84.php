<?php $__env->startSection('title', 'Masuk — Lapak Gaming'); ?>
  ...
  <div class="w-full max-w-[420px] animate-fade-up relative z-10">
    ...
    <div class="text-center mb-8">
      <a href="<?php echo e(route('marketplace.home')); ?>" class="inline-flex items-center gap-2.5 mb-5 group">
        <div class="relative">
          ...
          <img src="<?php echo e(url('storage/app/public/logo/logo.png')); ?>"
               alt="Lapak Gaming"
    ...
    <div class="auth-card p-7 sm:p-8">
      ...
      <div class="auth-error mb-5">
        ...
        <p class="text-sm text-red-300 leading-relaxed"><?php echo e($errors->first()); ?></p>
      </div>
      <?php endif; ?>

      
      <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4" id="login-form" novalidate>
        <?php echo csrf_field(); ?>
        ...
        <div>
          ...
          <div class="input-icon-wrap">
            ...
            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>"
                   class="input <?php echo e($errors->has('email') ? 'border-red-500/50 focus:border-red-500' : ''); ?>"
        ...
        <div>
          <div class="flex items-center justify-between mb-1.5">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-brand-400 hover:text-brand-300 transition-colors font-medium hover:underline">
              Lupa password?
            </a>
          </div>
      ...
      <a href="<?php echo e(route('google.auth')); ?>" class="btn-google">
      ...
      <p class="text-center text-sm text-slate-400 mt-6">
        Belum punya akun?
        <a href="<?php echo e(route('register')); ?>" class="text-brand-400 hover:text-brand-300 font-semibold transition-colors ml-1 hover:underline">
          Daftar gratis →
        </a>
      </p>
    ...
    <p class="text-center text-xs text-slate-600 mt-5">
      ...
      <a href="<?php echo e(route('terms')); ?>" class="text-slate-500 hover:text-slate-400 underline">Syarat Layanan</a>
      dan
      <a href="<?php echo e(route('privacy')); ?>" class="text-slate-500 hover:text-slate-400 underline">Kebijakan Privasi</a>
      Lapak Gaming.
    </p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\auth\login.blade.php ENDPATH**/ ?>