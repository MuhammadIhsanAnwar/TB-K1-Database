        ...
        <div class="rounded-3xl border border-slate-800 bg-slate-950 p-8">
            ...
            <div class="grid gap-6 lg:grid-cols-2 mb-8">
                <div class="rounded-3xl border border-slate-800 bg-slate-900 p-6">
                    ...
                    <form action="<?php echo e(route('settings.deactivate')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div class="rounded-3xl border border-slate-800 bg-slate-900 p-6">
                    ...
                    <form action="<?php echo e(route('settings.account.sendDeletionCode')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
            ...
            <form action="<?php echo e(route('settings.destroy')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>

                <div>
                    <label for="deletion_code" class="block text-sm font-medium text-slate-300 mb-2">Kode Verifikasi</label>
                    <input id="deletion_code" name="deletion_code" type="text" maxlength="6" value="<?php echo e(old('deletion_code')); ?>" class="w-full rounded-2xl border border-slate-800 bg-slate-900 px-4 py-3 text-slate-200" placeholder="Masukkan 6 digit kode">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\settings\delete-account.blade.php ENDPATH**/ ?>