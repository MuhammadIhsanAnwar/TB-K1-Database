        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div class="rounded-3xl p-5 panel-card-glass flex items-start gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <h2 class="text-base font-bold text-white tracking-tight truncate"><?php echo e($order->buyer->name ?? 'Deleted Account'); ?></h2>
                    <p class="text-xs text-slate-400 truncate mt-0.5 font-medium"><?php echo e($order->buyer->email ?? '—'); ?></p>
                </div>
            </div>
            ...
            <div class="rounded-3xl p-5 panel-card-glass flex items-start gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <h2 class="text-base font-bold text-slate-300 tracking-tight truncate"><?php echo e($order->seller->name ?? 'Deleted Store'); ?></h2>
                    <p class="text-xs text-slate-400 truncate mt-0.5 font-medium"><?php echo e($order->seller->email ?? '—'); ?></p>
                </div>
            </div>
        </div>
                ...
                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-5 hover:bg-black/10 transition-colors">
                        <div class="flex items-center gap-3.5">
                            ...
                            <div>
                                <h3 class="font-bold text-white text-base tracking-tight"><?php echo e($item->product_name); ?></h3>
                                <p class="text-xs text-slate-500 mt-0.5 font-medium">Kuantitas Pembelian: <?php echo e($item->quantity); ?> Item</p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0_Project_VS_Code\3. Sistem Basis Data\TB-K1-Database\lapak_gaming\resources\views\admin\orders\show.blade.php ENDPATH**/ ?>